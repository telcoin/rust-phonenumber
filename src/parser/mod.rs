...
mod test {
    ...
    fn reload_country() {
        ...
        assert_eq!(
            expected,
            parser::parse(Some(country::GB), "7511112222").unwrap()
        );
        assert_eq!(
            expected,
            parser::parse(Some(country::GB), "07511112222").unwrap()
        );
        ...
        assert_eq!(
            expected,
            parser::parse(Some(country::GB), "+447511112222").unwrap()
        );
        assert_eq!(
            expected,
            parser::parse(Some(country::GB), "+4407511112222").unwrap()
        );
        assert_eq!(
            expected,
            parser::parse(Some(country::FR), "+447511112222").unwrap()
        );
        assert_eq!(
            expected,
            parser::parse(Some(country::FR), "+4407511112222").unwrap()
        );
